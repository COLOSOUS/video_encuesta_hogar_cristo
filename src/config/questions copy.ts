    ...
    questions: [
      {
        id: 'video3',
        type: 'video',
        label: 'Supón que esta persona ya te está escuchando.\\n Ya le dijiste que eras voluntario del Hogar de Cristo y ahora estás lista/o para contarle sobre alguno de los programas de Hogar.\\n Piensa un momento tu respuesta y luego graba como si le estuvieras hablando a ella directamente:',
    ...
    questions: [
      {
        id: 'video4',
        type: 'video',
        label: 'Supón que esta persona ya te está escuchando.\\n Ya le dijiste que eras captador del Hogar de Cristo y ahora estás lista/o para contarle sobre alguno de los programas de Hogar.\\n Piensa un momento tu respuesta y luego graba como si le estuvieras hablando a ella:',
